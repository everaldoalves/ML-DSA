...
#include <cassert>
#include <sched.h>  // Para definir afinidade da CPU no Linux
...
// Definir o teste em apenas um núcleo da cpu
...
static void BM_ntt_referencia(benchmark::State& state) {
    set_cpu_affinity(0);  // Definir afinidade da CPU para o núcleo 0
